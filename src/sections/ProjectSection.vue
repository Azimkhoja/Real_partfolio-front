    ...
    <div class="flex flex-col items-center">
      ...
      <div class="card-wrapper container flex justify-center flex-wrap mt-[67px] gap-32">
        ...
        <div class="card flex flex-col bg-[#272727] shadow-lg rounded-[18px]">
          ...
          <div class="p-6">
            <h1 class="text-xl text-white font-bold">Portfolio Website</h1>
            <div class="flex items-center mt-2 mb-8">
              <i class="bx bx-code-alt text-[#13ff00] text-4xl"></i>
              <p class="text-white ml-3 text-lg">Backend & frontend sides</p>
            </div>
        ...
        <div class="card flex flex-col bg-[#272727] shadow-lg rounded-[18px]">
          ...
          <div class="p-6">
            ...
            <div class="flex items-center mt-2 mb-8">
              <i class="bx bx-code-alt text-[#13ff00] text-4xl"></i>
              <p class="text-white ml-3 text-lg">Backend & frontend </p>
            </div>
            <div class="flex justify-between">
              <div class="flex items-center">
                <p class="text-white mr-2 text-lg">View code</p>
